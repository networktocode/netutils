...
data = [
    ...
    ConfigLine(config_line=".   Access to this system is limited to authorized", parents=()),
    ConfigLine(config_line=".          users and for official purposes only", parents=()),
    ConfigLine(config_line=".", parents=()),
    ConfigLine(config_line=".       Your activities will be logged and abuse", parents=()),
    ConfigLine(config_line=".                     will be reported!", parents=()),
    ConfigLine(config_line=".", parents=()),
    ConfigLine(config_line="+----------------+ WARNING RUCKUS SWITCH +---------------+ $", parents=()),
