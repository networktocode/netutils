...
data = [
    ...
    ConfigLine(config_line="   Weekday 08:00 to 18:00", parents=("time-range periodic working-hours",)),
    ConfigLine(config_line="time-range periodic night-hours", parents=()),
    ConfigLine(config_line="   Weekday 18:01 to 23:59", parents=("time-range periodic night-hours",)),
    ConfigLine(config_line="   Weekday 00:00 to 07:59", parents=("time-range periodic night-hours",)),
    ConfigLine(config_line="netdestination wificalling-block", parents=()),
    ConfigLine(config_line="   name pub.test.org", parents=("netdestination wificalling-block",)),
    ConfigLine(config_line="   name testwifi.com", parents=("netdestination wificalling-block",)),
    ConfigLine(config_line="netdestination6 ipv6-reserved-range", parents=()),
    ConfigLine(config_line="   network 2000::/3", parents=("netdestination6 ipv6-reserved-range",)),
    ...
    ConfigLine(
        config_line="   any alias wificalling-block any deny", parents=("ip access-list session wificalling-block",)
    ),
    ConfigLine(config_line="ip access-list session v6-control", parents=()),
    ConfigLine(config_line="   ipv6 user any udp 546 deny", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-v6-icmp permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-dns permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-papi permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-sec-papi permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-cfgm-tcp permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-adp permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-tftp permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-v6-dhcp permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-natt permit", parents=("ip access-list session v6-control",)),
    ConfigLine(config_line="   ipv6 any any svc-dhcp permit", parents=("ip access-list session v6-control",)),
    ...
    ConfigLine(config_line="   any any svc-dns permit", parents=("ip access-list session dns-acl",)),
    ConfigLine(config_line="ip access-list session svp-acl", parents=()),
    ConfigLine(config_line="   any any svc-svp permit queue high", parents=("ip access-list session svp-acl",)),
    ConfigLine(config_line="   user host 224.0.1.116 any permit", parents=("ip access-list session svp-acl",)),
    ConfigLine(config_line="ip access-list session v6-http-acl", parents=()),
    ConfigLine(config_line="   ipv6 any any svc-http permit", parents=("ip access-list session v6-http-acl",)),
    ConfigLine(config_line="ip access-list session srcnat", parents=()),
    ConfigLine(config_line="   user any any src-nat", parents=("ip access-list session srcnat",)),
    ...
    ConfigLine(
        config_line="   any any app alg-skype4b-audio permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
        config_line="   any any app alg-skype4b-video permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
    ...
    ConfigLine(
        config_line="   any any app alg-sip-audio permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
        config_line="   any any app alg-sip-video permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(config_line="   any any app alg-sccp permit", parents=("ip access-list session voip-applications-acl",)),
    ConfigLine(
        config_line="   any any app alg-vocera permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(config_line="   any any app alg-noe permit", parents=("ip access-list session voip-applications-acl",)),
    ConfigLine(config_line="   any any app alg-h323 permit", parents=("ip access-list session voip-applications-acl",)),
    ConfigLine(
        config_line="   any any app alg-jabber-audio permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
        config_line="   any any app alg-jabber-video permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
    ...
    ConfigLine(
        config_line="   any any app alg-facetime permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
        config_line="   any any app alg-wifi-calling permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
        config_line="   any any app alg-teams-audio permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(
        config_line="   any any app alg-teams-video permit", parents=("ip access-list session voip-applications-acl",)
    ),
    ConfigLine(config_line="   any any app alg-rtp permit", parents=("ip access-list session voip-applications-acl",)),
    ConfigLine(config_line="ip access-list session allow-diskservices", parents=()),
    ConfigLine(config_line="   any any svc-netbios-dgm permit", parents=("ip access-list session allow-diskservices",)),
    ConfigLine(config_line="   any any svc-netbios-ssn permit", parents=("ip access-list session allow-diskservices",)),
    ConfigLine(
        config_line="   any any svc-microsoft-ds permit", parents=("ip access-list session allow-diskservices",)
    ),
    ConfigLine(config_line="   any any svc-netbios-ns permit", parents=("ip access-list session allow-diskservices",)),
    ...
    ConfigLine(config_line="   any any svc-dhcp permit", parents=("ip access-list session dhcp-acl",)),
    ConfigLine(config_line="ip access-list session logon-control-bridge", parents=()),
    ConfigLine(config_line="   user any udp 68 deny", parents=("ip access-list session logon-control-bridge",)),
    ConfigLine(config_line="   any any svc-icmp src-nat", parents=("ip access-list session logon-control-bridge",)),
    ConfigLine(config_line="   any any svc-dns src-nat", parents=("ip access-list session logon-control-bridge",)),
    ConfigLine(config_line="   any any svc-dhcp permit", parents=("ip access-list session logon-control-bridge",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   user any svc-ike permit", parents=("ip access-list session vpnlogon",)),
    ConfigLine(config_line="   user any svc-esp permit", parents=("ip access-list session vpnlogon",)),
    ConfigLine(config_line="   any any svc-l2tp permit", parents=("ip access-list session vpnlogon",)),
    ConfigLine(config_line="   any any svc-pptp permit", parents=("ip access-list session vpnlogon",)),
    ConfigLine(config_line="   any any svc-gre permit", parents=("ip access-list session vpnlogon",)),
    ConfigLine(config_line="ip access-list session v6-icmp-acl", parents=()),
    ConfigLine(config_line="   ipv6 any any svc-v6-icmp permit", parents=("ip access-list session v6-icmp-acl",)),
    ConfigLine(config_line="ip access-list session wificalling-acl", parents=()),
    ConfigLine(config_line="   any any tcp 443 permit", parents=("ip access-list session wificalling-acl",)),
    ConfigLine(config_line="ip access-list session tftp-acl", parents=()),
    ConfigLine(config_line="   any any svc-tftp permit", parents=("ip access-list session tftp-acl",)),
    ConfigLine(config_line="ip access-list session captiveportal", parents=()),
    ConfigLine(
        config_line="   user alias controller svc-https dst-nat 8081", parents=("ip access-list session captiveportal",)
    ),
    ConfigLine(config_line="   user any svc-http dst-nat 8080", parents=("ip access-list session captiveportal",)),
    ConfigLine(config_line="   user any svc-https dst-nat 8081", parents=("ip access-list session captiveportal",)),
    ConfigLine(
        config_line="   user any svc-http-proxy1 dst-nat 8088", parents=("ip access-list session captiveportal",)
    ),
    ConfigLine(
        config_line="   user any svc-http-proxy2 dst-nat 8088", parents=("ip access-list session captiveportal",)
    ),
    ConfigLine(
        config_line="   user any svc-http-proxy3 dst-nat 8088", parents=("ip access-list session captiveportal",)
    ),
    ...
    ConfigLine(config_line="ip access-list session apprf-default-iap-user-role-sacl", parents=()),
    ConfigLine(config_line="ip access-list session skype4b-acl", parents=()),
    ConfigLine(config_line="   any any svc-sips permit", parents=("ip access-list session skype4b-acl",)),
    ConfigLine(config_line="   any any svc-https permit", parents=("ip access-list session skype4b-acl",)),
    ConfigLine(config_line="ip access-list session ap-acl", parents=()),
    ConfigLine(config_line="   any any svc-gre permit", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="   any any svc-syslog permit", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="   any user svc-snmp permit", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="   user any svc-snmp-trap permit", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="   user any svc-ntp permit", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="   user any svc-ftp permit", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="   user any svc-telnet deny", parents=("ip access-list session ap-acl",)),
    ConfigLine(config_line="ip access-list session v6-allowall", parents=()),
    ConfigLine(config_line="   ipv6 any any any permit", parents=("ip access-list session v6-allowall",)),
    ...
    ConfigLine(config_line="   any any tcp 5222 permit", parents=("ip access-list session jabber-acl",)),
    ConfigLine(config_line="   any any tcp 8443 permit", parents=("ip access-list session jabber-acl",)),
    ConfigLine(config_line="ip access-list session apprf-block-mdns-usertouser-sacl", parents=()),
    ...
    ConfigLine(config_line="   user any udp 68 deny", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-icmp permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-dns permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-papi permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-sec-papi permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-cfgm-tcp permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-adp permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-tftp permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-dhcp permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any svc-natt permit", parents=("ip access-list session control",)),
    ConfigLine(config_line="   any any tcp 6633 permit", parents=("ip access-list session control",)),
    ...
    ConfigLine(config_line="   user any udp 68 deny", parents=("ip access-list session logon-control",)),
    ConfigLine(config_line="   any any svc-icmp permit", parents=("ip access-list session logon-control",)),
    ConfigLine(config_line="   any any svc-dns permit", parents=("ip access-list session logon-control",)),
    ConfigLine(config_line="   any any svc-dhcp permit", parents=("ip access-list session logon-control",)),
    ConfigLine(config_line="   any any svc-natt permit", parents=("ip access-list session logon-control",)),
    ConfigLine(
        config_line="   any network 169.254.0.0 255.255.0.0 any deny", parents=("ip access-list session logon-control",)
    ),
    ConfigLine(
        config_line="   any network 240.0.0.0 240.0.0.0 any deny", parents=("ip access-list session logon-control",)
    ),
    ConfigLine(config_line="ip access-list session v6-dns-acl", parents=()),
    ConfigLine(config_line="   ipv6 any any svc-dns permit", parents=("ip access-list session v6-dns-acl",)),
    ConfigLine(config_line="ip access-list session ap-uplink-acl", parents=()),
    ConfigLine(config_line="   any any udp 68 permit", parents=("ip access-list session ap-uplink-acl",)),
    ConfigLine(config_line="   any any svc-icmp permit", parents=("ip access-list session ap-uplink-acl",)),
    ConfigLine(
        config_line="   any host 224.0.0.251 udp 5353 permit", parents=("ip access-list session ap-uplink-acl",)
    ),
    ConfigLine(config_line="   ipv6 any any udp 546 permit", parents=("ip access-list session ap-uplink-acl",)),
    ConfigLine(config_line="   ipv6 any any svc-v6-icmp permit", parents=("ip access-list session ap-uplink-acl",)),
    ConfigLine(
        config_line="   ipv6 any host ff02::fb udp 5353 permit", parents=("ip access-list session ap-uplink-acl",)
    ),
    ...
    ConfigLine(config_line="   any any svc-noe permit queue high", parents=("ip access-list session noe-acl",)),
    ConfigLine(config_line="ip access-list session v6-https-acl", parents=()),
    ConfigLine(config_line="   ipv6 any any svc-https permit", parents=("ip access-list session v6-https-acl",)),
    ConfigLine(config_line="ip access-list session v6-ap-acl", parents=()),
    ConfigLine(config_line="   ipv6 any any svc-gre permit", parents=("ip access-list session v6-ap-acl",)),
    ConfigLine(config_line="   ipv6 any any svc-syslog permit", parents=("ip access-list session v6-ap-acl",)),
    ConfigLine(config_line="   ipv6 any user svc-snmp permit", parents=("ip access-list session v6-ap-acl",)),
    ConfigLine(config_line="   ipv6 user any svc-snmp-trap permit", parents=("ip access-list session v6-ap-acl",)),
    ConfigLine(config_line="   ipv6 user any svc-ntp permit", parents=("ip access-list session v6-ap-acl",)),
    ConfigLine(config_line="   ipv6 user any svc-ftp permit", parents=("ip access-list session v6-ap-acl",)),
    ...
    ConfigLine(config_line="   any any svc-https permit", parents=("ip access-list session https-acl",)),
    ConfigLine(config_line="ip access-list session skinny-acl", parents=()),
    ConfigLine(config_line="   any any svc-sccp permit queue high", parents=("ip access-list session skinny-acl",)),
    ConfigLine(config_line="ip access-list session wan-uplink-protect-acl", parents=()),
    ConfigLine(
        config_line="   any any sys-svc-dhcp permit", parents=("ip access-list session wan-uplink-protect-acl",)
    ),
    ConfigLine(
        config_line="   any any sys-svc-v6-dhcp permit", parents=("ip access-list session wan-uplink-protect-acl",)
    ),
    ConfigLine(config_line="   any any sys-svc-esp permit", parents=("ip access-list session wan-uplink-protect-acl",)),
    ConfigLine(
        config_line="   any any sys-svc-natt permit", parents=("ip access-list session wan-uplink-protect-acl",)
    ),
    ConfigLine(config_line="   any any sys-svc-ike permit", parents=("ip access-list session wan-uplink-protect-acl",)),
    ConfigLine(
        config_line="   any any sys-svc-icmp permit", parents=("ip access-list session wan-uplink-protect-acl",)
    ),
    ConfigLine(
        config_line="   any any sys-svc-icmp6 permit", parents=("ip access-list session wan-uplink-protect-acl",)
    ),
    ConfigLine(config_line="ip access-list session vocera-acl", parents=()),
    ConfigLine(config_line="   any any svc-vocera permit queue high", parents=("ip access-list session vocera-acl",)),
    ConfigLine(config_line="ip access-list session http-acl", parents=()),
    ConfigLine(config_line="   any any svc-http permit", parents=("ip access-list session http-acl",)),
    ...
    ConfigLine(config_line="   ipv6 user any svc-http captive", parents=("ip access-list session captiveportal6",)),
    ConfigLine(config_line="   ipv6 user any svc-https captive", parents=("ip access-list session captiveportal6",)),
    ConfigLine(
        config_line="   ipv6 user any svc-http-proxy1 captive", parents=("ip access-list session captiveportal6",)
    ),
    ConfigLine(
        config_line="   ipv6 user any svc-http-proxy2 captive", parents=("ip access-list session captiveportal6",)
    ),
    ConfigLine(
        config_line="   ipv6 user any svc-http-proxy3 captive", parents=("ip access-list session captiveportal6",)
    ),
    ConfigLine(config_line="ip access-list session allow-printservices", parents=()),
    ConfigLine(config_line="   any any svc-lpd permit", parents=("ip access-list session allow-printservices",)),
    ConfigLine(config_line="   any any svc-ipp-tcp permit", parents=("ip access-list session allow-printservices",)),
    ConfigLine(config_line="   any any svc-ipp-udp permit", parents=("ip access-list session allow-printservices",)),
    ...
    ConfigLine(config_line="   ipv6 user any icmpv6 rtr-adv deny", parents=("ip access-list session ra-guard",)),
    ...
    ConfigLine(
        config_line="   any any svc-ica permit tos 46 dot1p-priority 6", parents=("ip access-list session citrix-acl",)
    ),
    ConfigLine(config_line="ip access-list session allowall", parents=()),
    ConfigLine(config_line="   any any any permit", parents=("ip access-list session allowall",)),
    ConfigLine(config_line="   ipv6 any any any permit", parents=("ip access-list session allowall",)),
    ConfigLine(config_line="ip access-list session facetime-acl", parents=()),
    ConfigLine(
        config_line="   any any svc-facetime-tcp permit queue high", parents=("ip access-list session facetime-acl",)
    ),
    ConfigLine(config_line="   any any udp 3478 3497 permit", parents=("ip access-list session facetime-acl",)),
    ConfigLine(config_line="   any any udp 16384 16387 permit", parents=("ip access-list session facetime-acl",)),
    ConfigLine(config_line="   any any udp 16393 16402 permit", parents=("ip access-list session facetime-acl",)),
    ConfigLine(config_line="ip access-list session validuser", parents=()),
    ConfigLine(
        config_line="   network 127.0.0.0 255.0.0.0 any any deny", parents=("ip access-list session validuser",)
    ),
    ConfigLine(
        config_line="   network 169.254.0.0 255.255.0.0 any any deny", parents=("ip access-list session validuser",)
    ),
    ConfigLine(
        config_line="   network 224.0.0.0 240.0.0.0 any any deny", parents=("ip access-list session validuser",)
    ),
    ConfigLine(config_line="   host 255.255.255.255 any any deny", parents=("ip access-list session validuser",)),
    ConfigLine(
        config_line="   network 240.0.0.0 240.0.0.0 any any deny", parents=("ip access-list session validuser",)
    ),
    ConfigLine(config_line="   any any any permit", parents=("ip access-list session validuser",)),
    ConfigLine(config_line="   ipv6 host fe80:: any any deny", parents=("ip access-list session validuser",)),
    ConfigLine(config_line="   ipv6 network fc00::/7 any any permit", parents=("ip access-list session validuser",)),
    ConfigLine(config_line="   ipv6 network fe80::/64 any any permit", parents=("ip access-list session validuser",)),
    ConfigLine(
        config_line="   ipv6 alias ipv6-reserved-range any any deny", parents=("ip access-list session validuser",)
    ),
    ConfigLine(config_line="   ipv6 any any any permit", parents=("ip access-list session validuser",)),
    ...
    ConfigLine(
        config_line="   user alias controller svc-https dst-nat 8081", parents=("ip access-list session cplogout",)
    ),
    ConfigLine(config_line="ip access-list session sip-acl", parents=()),
    ConfigLine(config_line="   any any svc-sip-udp permit queue high", parents=("ip access-list session sip-acl",)),
    ConfigLine(config_line="   any any svc-sip-tcp permit queue high", parents=("ip access-list session sip-acl",)),
    ConfigLine(config_line="ip access-list session v6-logon-control", parents=()),
    ConfigLine(config_line="   ipv6 user any udp 546 deny", parents=("ip access-list session v6-logon-control",)),
    ConfigLine(config_line="   ipv6 any any svc-v6-icmp permit", parents=("ip access-list session v6-logon-control",)),
    ConfigLine(config_line="   ipv6 any any svc-v6-dhcp permit", parents=("ip access-list session v6-logon-control",)),
    ConfigLine(config_line="   ipv6 any any svc-dns permit", parents=("ip access-list session v6-logon-control",)),
    ConfigLine(
        config_line="   ipv6 any network fc00::/7 any permit", parents=("ip access-list session v6-logon-control",)
    ),
    ConfigLine(
        config_line="   ipv6 any network fe80::/64 any permit", parents=("ip access-list session v6-logon-control",)
    ),
    ConfigLine(
    ...
    ConfigLine(config_line="   any any svc-icmp permit", parents=("ip access-list session icmp-acl",)),
    ConfigLine(config_line="ip access-list session v6-dhcp-acl", parents=()),
    ConfigLine(config_line="   ipv6 any any svc-v6-dhcp permit", parents=("ip access-list session v6-dhcp-acl",)),
    ConfigLine(config_line="ip access-list session h323-acl", parents=()),
    ConfigLine(config_line="   any any svc-h323-tcp permit queue high", parents=("ip access-list session h323-acl",)),
    ConfigLine(config_line="   any any svc-h323-udp permit queue high", parents=("ip access-list session h323-acl",)),
    ...
    ConfigLine(
        config_line="   access-list session Block-MDNS-UsertoUser", parents=("user-role Block-MDNS-UsertoUser",)
    ),
    ConfigLine(config_line="user-role default-iap-user-role", parents=()),
    ConfigLine(config_line="user-role default-via-role", parents=()),
    ConfigLine(config_line="   access-list session allowall", parents=("user-role default-via-role",)),
    ConfigLine(config_line="   access-list session v6-allowall", parents=("user-role default-via-role",)),
    ConfigLine(config_line="user-role default-vpn-role", parents=()),
    ConfigLine(config_line="   access-list session ra-guard", parents=("user-role default-vpn-role",)),
    ConfigLine(config_line="   access-list session allowall", parents=("user-role default-vpn-role",)),
    ConfigLine(config_line="   access-list session v6-allowall", parents=("user-role default-vpn-role",)),
    ConfigLine(config_line="user-role authenticated", parents=()),
    ConfigLine(config_line="   access-list session ra-guard", parents=("user-role authenticated",)),
    ConfigLine(config_line="   access-list session allowall", parents=("user-role authenticated",)),
    ConfigLine(config_line="   access-list session v6-allowall", parents=("user-role authenticated",)),
    ...
    ConfigLine(config_line="   access-list session ra-guard", parents=("user-role guest-logon",)),
    ConfigLine(config_line="   access-list session logon-control", parents=("user-role guest-logon",)),
    ConfigLine(config_line="   access-list session captiveportal", parents=("user-role guest-logon",)),
    ConfigLine(config_line="   access-list session v6-logon-control", parents=("user-role guest-logon",)),
    ConfigLine(config_line="   access-list session captiveportal6", parents=("user-role guest-logon",)),
    ...
    ConfigLine(config_line="   access-list session wificalling-acl", parents=("user-role voice",)),
    ConfigLine(config_line="   access-list session voip-applications-acl", parents=("user-role voice",)),
    ...
    ConfigLine(config_line="   access-list session v6-logon-control", parents=("user-role logon",)),
    ConfigLine(config_line="   access-list session captiveportal6", parents=("user-role logon",)),
    ...
    ConfigLine(config_line="   description GE0/0/2", parents=("interface gigabitethernet 0/0/2",)),
    ConfigLine(config_line="   switchport mode trunk", parents=("interface gigabitethernet 0/0/2",)),
    ...
    ConfigLine(config_line="   trusted vlan 1-4094", parents=("interface gigabitethernet 0/0/2",)),
    ConfigLine(config_line="   lacp group 0 mode active", parents=("interface gigabitethernet 0/0/2",)),
    ConfigLine(config_line="interface gigabitethernet 0/0/3", parents=()),
    ConfigLine(config_line="   description GE0/0/3", parents=("interface gigabitethernet 0/0/3",)),
    ConfigLine(config_line="   switchport mode trunk", parents=("interface gigabitethernet 0/0/3",)),
    ...
    ConfigLine(config_line="   trusted vlan 1-4094", parents=("interface gigabitethernet 0/0/3",)),
    ConfigLine(config_line="   lacp group 0 mode active", parents=("interface gigabitethernet 0/0/3",)),
    ...
    ConfigLine(config_line="   switchport trunk native vlan 1", parents=("interface port-channel 0",)),
    ...
    ConfigLine(config_line="   ip address 8.8.8.8 255.255.255.240", parents=("interface vlan 12",)),
    ...
    ConfigLine(config_line="crypto-local isakmp dpd idle-timeout 22 retry-timeout 2 retry-attempts 3", parents=()),
    ...
    ConfigLine(config_line="   authentication pre-share", parents=("crypto isakmp policy 10013",)),
    ...
    ConfigLine(config_line="crypto ipsec transform-set default-ha-transform esp-3des esp-sha-hmac", parents=()),
    ConfigLine(
        config_line="crypto ipsec transform-set default-1st-ikev2-transform esp-aes256 esp-sha-hmac", parents=()
    ),
    ConfigLine(config_line="crypto ipsec transform-set default-gcm256 esp-aes256-gcm", parents=()),
    ConfigLine(config_line="crypto ipsec transform-set default-ml-transform esp-3des esp-sha-hmac", parents=()),
    ConfigLine(config_line="crypto ipsec transform-set default-boc-bm-transform esp-aes256 esp-sha-hmac", parents=()),
    ConfigLine(
        config_line="crypto ipsec transform-set default-3rd-ikev2-transform esp-aes128 esp-sha-hmac", parents=()
    ),
    ConfigLine(config_line="crypto ipsec transform-set default-aes esp-aes256 esp-sha-hmac", parents=()),
    ConfigLine(config_line="crypto ipsec transform-set default-transform esp-3des esp-sha-hmac", parents=()),
    ConfigLine(config_line="crypto ipsec transform-set default-cluster-transform esp-aes256 esp-sha-hmac", parents=()),
    ConfigLine(config_line="crypto ipsec transform-set default-gcm128 esp-aes128-gcm", parents=()),
    ConfigLine(config_line="crypto ipsec transform-set default-rap-transform esp-aes256 esp-sha-hmac", parents=()),
    ...
    ConfigLine(config_line="   version v1", parents=("crypto dynamic-map default-dynamicmap 10000",)),
    ...
    ConfigLine(config_line="   version v2", parents=("crypto dynamic-map default-rap-ipsecmap 10001",)),
    ...
    ConfigLine(config_line="   version v2", parents=("crypto dynamic-map default-ikev2-dynamicmap 10000",)),
    ...
    ConfigLine(config_line="   version v2", parents=("crypto dynamic-map default-rap-ipsecmap-aes 10001",)),
    ...
    ConfigLine(config_line="   version v2", parents=("crypto dynamic-map default-rap-ipsecmap-gcm 10001",)),
    ...
    ConfigLine(config_line="mgmt-server primary-server 192.168.5.5 profile default-amp", parents=()),
    ConfigLine(config_line="mgmt-server primary-server conductor profile default-controller transport udp", parents=()),
    ConfigLine(config_line="adp igmp-vlan 0", parents=()),
    ConfigLine(config_line="mgmt-user admin root ********************", parents=()),
    ConfigLine(config_line="mgmt-user ssh-pubkey client-cert master-ssh-pub-cert seamless-logon read-only", parents=()),
    ConfigLine(
        config_line="mgmt-user ssh-pubkey client-cert master-ssh-pub-cert seamless-logon-w standard", parents=()
    ),
    ...
    ConfigLine(config_line="cp-bandwidth-contract cpbwc-ipv4-file-transfer pps 8000", parents=()),
    ...
    ConfigLine(config_line="cp-bandwidth-contract cpbwc-ipv6-file-transfer pps 8000", parents=()),
    ...
    ConfigLine(config_line="   ipv4 permit any proto 6 ports 9199 9199", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv4 permit any proto 6 ports 8089 8089", parents=("firewall cp",)),
    ConfigLine(
        config_line="   ipv4 permit any proto 6 ports 17 17 bandwidth-contract cpbwc-ipv4-others",
        parents=("firewall cp",),
    ),
    ConfigLine(config_line="   ipv4 permit any proto 50 ports 0 65535", parents=("firewall cp",)),
    ConfigLine(
        config_line="   ipv4 permit any proto 17 ports 8200 8200 bandwidth-contract cpbwc-ipv4-others",
        parents=("firewall cp",),
    ),
    ConfigLine(config_line="   ipv4 permit any proto 112 ports 0 65535", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv4 permit any proto 89 ports 0 65535", parents=("firewall cp",)),
    ...
    ConfigLine(config_line="   ipv4 deny any proto 17 ports 1701 1701", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv4 permit any proto 17 ports 8211 8211", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv4 permit any proto 17 ports 5060 5060", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv4 permit any proto 6 ports 8212 8212", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv4 permit any proto 17 ports 4500 4500", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv4 permit any proto 17 ports 1702 1702", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv6 permit any proto 47 ports 0 65535", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv6 permit any proto 17 ports 8209 8209", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 8090 8090", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 9090 9090", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 6008 6008", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 15720 15720", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv6 permit any proto 17 ports 15267 15267", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 9091 9091", parents=("firewall cp",)),
    ...
    ConfigLine(config_line="   ipv6 deny any proto 17 ports 1701 1701", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv6 permit any proto 17 ports 8211 8211", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 8211 8211", parents=("firewall cp",)),
    ConfigLine(
    ...
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 9190 9190", parents=("firewall cp",)),
    ConfigLine(config_line="   ipv6 permit any proto 6 ports 15260 15260", parents=("firewall cp",)),
    ...
    ConfigLine(config_line='   host "192.168.5.5"', parents=('aaa authentication-server tacacs "TACACS_SERVER1"',)),
    ConfigLine(config_line="   key password", parents=('aaa authentication-server tacacs "TACACS_SERVER1"',)),
    ConfigLine(config_line="   session-authorization", parents=('aaa authentication-server tacacs "TACACS_SERVER1"',)),
    ConfigLine(config_line='aaa authentication-server tacacs "TACACS_SERVER2"', parents=()),
    ConfigLine(config_line='   host "192.168.5.6"', parents=('aaa authentication-server tacacs "TACACS_SERVER2"',)),
    ConfigLine(config_line="   key password", parents=('aaa authentication-server tacacs "TACACS_SERVER2"',)),
    ConfigLine(config_line="   session-authorization", parents=('aaa authentication-server tacacs "TACACS_SERVER2"',)),
    ...
    ConfigLine(config_line="   queue-weights q0 0 q1 0 q2 0 q3 0", parents=('scheduler-profile "default"',)),
    ConfigLine(
        config_line='   priority-map q0 "6 7" q1 "4 5" q2 "2 3" q3 "0 1"', parents=('scheduler-profile "default"',)
    ),
    ConfigLine(config_line='aaa server-group "default"', parents=()),
    ConfigLine(config_line="   auth-server TACACS_SERVER1 position 1", parents=('aaa server-group "default"',)),
    ConfigLine(config_line="   auth-server TACACS_SERVER2 position 2", parents=('aaa server-group "default"',)),
    ConfigLine(config_line="   set role condition role value-of", parents=('aaa server-group "default"',)),
    ConfigLine(config_line='aaa server-group "TACACS_GROUP"', parents=()),
    ConfigLine(config_line="   allow-fail-through", parents=('aaa server-group "TACACS_GROUP"',)),
    ConfigLine(config_line="   auth-server TACACS_SERVER1 position 1", parents=('aaa server-group "TACACS_GROUP"',)),
    ConfigLine(config_line="   auth-server TACACS_SERVER2 position 2", parents=('aaa server-group "TACACS_GROUP"',)),
    ConfigLine(config_line='aaa profile ".vlan1315"', parents=()),
    ConfigLine(config_line='   initial-role "authenticated"', parents=('aaa profile ".vlan1315"',)),
    ConfigLine(config_line='   authentication-dot1x ".vlan1315"', parents=('aaa profile ".vlan1315"',)),
    ConfigLine(config_line='aaa profile ".vlan1316"', parents=()),
    ConfigLine(config_line='   initial-role "authenticated"', parents=('aaa profile ".vlan1316"',)),
    ConfigLine(config_line='   authentication-dot1x ".vlan1316"', parents=('aaa profile ".vlan1316"',)),
    ConfigLine(config_line='aaa profile ".vlan1317"', parents=()),
    ConfigLine(config_line='   initial-role "authenticated"', parents=('aaa profile ".vlan1317"',)),
    ConfigLine(config_line='   authentication-dot1x ".vlan1317"', parents=('aaa profile ".vlan1317"',)),
    ConfigLine(config_line='aaa profile ".vlan1318"', parents=()),
    ConfigLine(config_line='   initial-role "authenticated"', parents=('aaa profile ".vlan1318"',)),
    ConfigLine(config_line='   authentication-dot1x ".vlan1318"', parents=('aaa profile ".vlan1318"',)),
    ConfigLine(config_line='aaa profile "default"', parents=()),
    ConfigLine(config_line='aaa profile "default-dot1x"', parents=()),
    ConfigLine(config_line='   authentication-dot1x "default"', parents=('aaa profile "default-dot1x"',)),
    ConfigLine(config_line='   dot1x-default-role "authenticated"', parents=('aaa profile "default-dot1x"',)),
    ConfigLine(config_line='aaa profile "default-dot1x-psk"', parents=()),
    ConfigLine(config_line='   authentication-dot1x "default-psk"', parents=('aaa profile "default-dot1x-psk"',)),
    ConfigLine(config_line='aaa profile "default-iap-aaa-profile"', parents=()),
    ConfigLine(
        config_line='   initial-role "default-iap-user-role"', parents=('aaa profile "default-iap-aaa-profile"',)
    ),
    ConfigLine(config_line="   no wired-to-wireless-roam", parents=('aaa profile "default-iap-aaa-profile"',)),
    ConfigLine(config_line="   no devtype-classification", parents=('aaa profile "default-iap-aaa-profile"',)),
    ConfigLine(config_line='aaa profile "default-mac-auth"', parents=()),
    ConfigLine(config_line='   authentication-mac "default"', parents=('aaa profile "default-mac-auth"',)),
    ConfigLine(config_line='   mac-default-role "authenticated"', parents=('aaa profile "default-mac-auth"',)),
    ConfigLine(config_line='aaa profile "default-open"', parents=()),
    ConfigLine(config_line='aaa profile "default-tunneled-user"', parents=()),
    ConfigLine(config_line='   initial-role "guest"', parents=('aaa profile "default-tunneled-user"',)),
    ConfigLine(config_line="   no wired-to-wireless-roam", parents=('aaa profile "default-tunneled-user"',)),
    ConfigLine(config_line="   no devtype-classification", parents=('aaa profile "default-tunneled-user"',)),
    ...
    ConfigLine(config_line='   default-role "sys-ap-role"', parents=('aaa authentication vpn "default-cap"',)),
    ConfigLine(config_line='   server-group "internal"', parents=('aaa authentication vpn "default-cap"',)),
    ...
    ConfigLine(config_line='   server-group "TACACS_GROUP"', parents=("aaa authentication mgmt",)),
    ...
    ConfigLine(config_line="   country-code US", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11g-channel 1", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11g-channel 6", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11g-channel 11", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 36", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 40", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 44", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 48", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 149", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 153", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 157", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 161", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11a-channel 165", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11g-40mhz-channel-pair 1-5", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(config_line="   valid-11g-40mhz-channel-pair 7-11", parents=('ap regulatory-domain-profile "default"',)),
    ConfigLine(
        config_line="   valid-11a-40mhz-channel-pair 36-40", parents=('ap regulatory-domain-profile "default"',)
    ),
    ConfigLine(
        config_line="   valid-11a-40mhz-channel-pair 44-48", parents=('ap regulatory-domain-profile "default"',)
    ),
    ConfigLine(
        config_line="   valid-11a-40mhz-channel-pair 149-153", parents=('ap regulatory-domain-profile "default"',)
    ),
    ConfigLine(
        config_line="   valid-11a-40mhz-channel-pair 157-161", parents=('ap regulatory-domain-profile "default"',)
    ),
    ConfigLine(
        config_line="   valid-11a-80mhz-channel-group 36-48", parents=('ap regulatory-domain-profile "default"',)
    ),
    ConfigLine(
        config_line="   valid-11a-80mhz-channel-group 149-161", parents=('ap regulatory-domain-profile "default"',)
    ),
    ConfigLine(
        config_line="   valid-11a-160mhz-channel-group 36-64", parents=('ap regulatory-domain-profile "default"',)
    ),
    ...
    ConfigLine(config_line="   switchport access vlan 12", parents=('ap wired-ap-profile "USERS"',)),
    ...
    ConfigLine(config_line="   bkup-lms-ip 172.16.5.5", parents=('ap system-profile "SYSTEM_PROF"',)),
    ConfigLine(config_line="   ap-console-password pass1", parents=('ap system-profile "SYSTEM_PROF"',)),
    ConfigLine(config_line="   bkup-passwords pass2", parents=('ap system-profile "SYSTEM_PROF"',)),
    ConfigLine(config_line='ap system-profile "default"', parents=()),
    ConfigLine(config_line="   ap-console-password passdefault", parents=('ap system-profile "default"',)),
    ...
    ConfigLine(config_line='   mesh-ht-ssid-profile "mesh"', parents=('ap mesh-radio-profile "mesh"',)),
    ...
    ConfigLine(config_line='   bridge-role "logon"', parents=('ap wired-port-profile "PORT-SHUTDOWN"',)),
    ConfigLine(config_line='ap wired-port-profile "NoAuthWiredPort"', parents=()),
    ConfigLine(config_line='   wired-ap-profile "NoAuthWiredAp"', parents=('ap wired-port-profile "NoAuthWiredPort"',)),
    ConfigLine(config_line='   aaa-profile "NoAuthAAAProfile"', parents=('ap wired-port-profile "NoAuthWiredPort"',)),
    ...
    ConfigLine(config_line='ids rate-thresholds-profile "probe-request-response-thresholds"', parents=()),
    ConfigLine(
    ...
    ConfigLine(config_line="   frame-type beacon ssid AirJack", parents=('ids signature-profile "AirJack"',)),
    ...
    ConfigLine(config_line='   signature "Disassoc-Broadcast"', parents=('ids signature-matching-profile "default"',)),
    ...
    ConfigLine(config_line='   arm-profile "maintain"', parents=('rf dot11a-radio-profile "maintain-a"',)),
    ConfigLine(config_line='rf dot11a-radio-profile "rp-monitor-a"', parents=()),
    ConfigLine(config_line="   mode am-mode", parents=('rf dot11a-radio-profile "rp-monitor-a"',)),
    ConfigLine(config_line='rf dot11a-radio-profile "rp-scan-a"', parents=()),
    ConfigLine(config_line='   arm-profile "scan"', parents=('rf dot11a-radio-profile "rp-scan-a"',)),
    ...
    ConfigLine(config_line='   arm-profile "maintain"', parents=('rf dot11g-radio-profile "maintain-g"',)),
    ConfigLine(config_line='rf dot11g-radio-profile "rp-monitor-g"', parents=()),
    ConfigLine(config_line="   mode am-mode", parents=('rf dot11g-radio-profile "rp-monitor-g"',)),
    ConfigLine(config_line='rf dot11g-radio-profile "rp-scan-g"', parents=()),
    ConfigLine(config_line='   arm-profile "scan"', parents=('rf dot11g-radio-profile "rp-scan-g"',)),
    ...
    ConfigLine(config_line='wlan hotspot h2qp-operator-friendly-name-profile "default"', parents=()),
    ...
    ConfigLine(config_line="   wpa-passphrase passphrase", parents=('wlan ssid-profile "ssid1"',)),
    ...
    ConfigLine(config_line="   wpa-passphrase passphrase", parents=('wlan ssid-profile "ssid2"',)),
    ...
    ConfigLine(config_line="   wpa-passphrase passphrase", parents=('wlan ssid-profile "ssid3"',)),
    ...
    ConfigLine(config_line="   monitored-info-enable", parents=('mgmt-server profile "default-acp"',)),
    ConfigLine(config_line="   monitored-info-del-enable", parents=('mgmt-server profile "default-acp"',)),
    ConfigLine(config_line="   monitored-info-snapshot-enable", parents=('mgmt-server profile "default-acp"',)),
    ConfigLine(config_line="   wids-event-info-enable", parents=('mgmt-server profile "default-acp"',)),
    ...
    ConfigLine(config_line="   uccmonitoring-enable", parents=('mgmt-server profile "default-acp"',)),
    ConfigLine(config_line="   airgroupinfo-enable", parents=('mgmt-server profile "default-acp"',)),
    ...
    ConfigLine(config_line="   uccmonitoring-enable", parents=('mgmt-server profile "default-ale"',)),
    ...
    ConfigLine(config_line="   user-visibility-enable", parents=('mgmt-server profile "default-amp"',)),
    ...
    ConfigLine(config_line="   stats-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   tag-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   sessions-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   user-visibility-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   misc-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   location-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   uccmonitoring-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   airgroupinfo-enable", parents=('mgmt-server profile "default-controller"',)),
    ConfigLine(config_line="   wan-state", parents=('mgmt-server profile "default-controller"',)),
    ...
    ConfigLine(config_line="   no generic-amon-enable", parents=('mgmt-server profile "default-niara"',)),
    ConfigLine(config_line="   sessions-enable", parents=('mgmt-server profile "default-niara"',)),
    ConfigLine(config_line="   no inline-dhcp-stats", parents=('mgmt-server profile "default-niara"',)),
    ConfigLine(config_line="   no inline-ap-stats", parents=('mgmt-server profile "default-niara"',)),
    ConfigLine(config_line="   no inline-auth-stats", parents=('mgmt-server profile "default-niara"',)),
    ConfigLine(config_line="   no inline-dns-stats", parents=('mgmt-server profile "default-niara"',)),
    ConfigLine(config_line='ap authorization-profile "default"', parents=()),
    ConfigLine(
        config_line='   ap-authorization-group "NoAuthApGroup"', parents=('ap authorization-profile "default"',)
    ),
    ...
    ConfigLine(config_line='   id "_airplay._tcp"', parents=('airgroupprofile service "default-airplay"',)),
    ConfigLine(config_line='   id "_appletv-v2._tcp"', parents=('airgroupprofile service "default-airplay"',)),
    ConfigLine(config_line='   id "_raop._tcp"', parents=('airgroupprofile service "default-airplay"',)),
    ConfigLine(config_line='   description "AirPlay"', parents=('airgroupprofile service "default-airplay"',)),
    ConfigLine(config_line='airgroupprofile service "default-allowall"', parents=()),
    ConfigLine(
        config_line='   description "Remaining-Services"', parents=('airgroupprofile service "default-allowall"',)
    ),
    ConfigLine(config_line='airgroupprofile service "default-amazontv"', parents=()),
    ConfigLine(config_line='   id "_amzn-wplay._tcp"', parents=('airgroupprofile service "default-amazontv"',)),
    ConfigLine(config_line='   description "Amazon fire tv"', parents=('airgroupprofile service "default-amazontv"',)),
    ...
    ConfigLine(config_line='   description "Print"', parents=('airgroupprofile service "default-dlna-print"',)),
    ConfigLine(config_line='airgroupprofile service "default-itunes"', parents=()),
    ConfigLine(config_line='   id "_apple-mobdev._tcp"', parents=('airgroupprofile service "default-itunes"',)),
    ConfigLine(config_line='   id "_daap._tcp"', parents=('airgroupprofile service "default-itunes"',)),
    ConfigLine(config_line='   id "_dacp._tcp"', parents=('airgroupprofile service "default-itunes"',)),
    ConfigLine(config_line='   id "_home-sharing._tcp"', parents=('airgroupprofile service "default-itunes"',)),
    ConfigLine(config_line='   description "iTunes"', parents=('airgroupprofile service "default-itunes"',)),
    ConfigLine(config_line='airgroupprofile service "default-remotemgmt"', parents=()),
    ConfigLine(config_line='   id "_ftp._tcp"', parents=('airgroupprofile service "default-remotemgmt"',)),
    ConfigLine(config_line='   id "_net-assistant._tcp"', parents=('airgroupprofile service "default-remotemgmt"',)),
    ConfigLine(config_line='   id "_rfb._tcp"', parents=('airgroupprofile service "default-remotemgmt"',)),
    ConfigLine(config_line='   id "_sftp-ssh._tcp"', parents=('airgroupprofile service "default-remotemgmt"',)),
    ConfigLine(config_line='   id "_ssh._tcp"', parents=('airgroupprofile service "default-remotemgmt"',)),
    ConfigLine(config_line='   id "_telnet._tcp"', parents=('airgroupprofile service "default-remotemgmt"',)),
    ConfigLine(
        config_line='   description "Remote management"', parents=('airgroupprofile service "default-remotemgmt"',)
    ),
    ConfigLine(config_line='airgroupprofile service "default-sharing"', parents=()),
    ConfigLine(config_line='   id "_afpovertcp._tcp"', parents=('airgroupprofile service "default-sharing"',)),
    ConfigLine(config_line='   id "_odisk._tcp"', parents=('airgroupprofile service "default-sharing"',)),
    ConfigLine(config_line='   id "_xgrid._tcp"', parents=('airgroupprofile service "default-sharing"',)),
    ConfigLine(config_line='   description "Sharing"', parents=('airgroupprofile service "default-sharing"',)),
    ...
    ConfigLine(config_line='   service "default-airplay"', parents=('airgroupprofile "default"',)),
    ConfigLine(config_line='   service "default-airprint"', parents=('airgroupprofile "default"',)),
    ConfigLine(config_line='   service "default-dial"', parents=('airgroupprofile "default"',)),
    ConfigLine(config_line='   disallow-role "" type servers service ""', parents=('airgroupprofile "default"',)),
    ...
    ConfigLine(config_line="snmp-server trap wlsxMalformedFrameWrongChannelDetected", parents=()),
    ...
    ConfigLine(config_line="snmp-server trap wlsxGlobalConfigurationChangeNotification", parents=()),
