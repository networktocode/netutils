...
data = [
    ...
    ConfigLine(config_line="vlan 15", parents=("vlan 10",)),
    ConfigLine(config_line="    name users", parents=("vlan 10", "vlan 15")),
    ConfigLine(config_line="    description users vlan", parents=("vlan 10", "vlan 15")),
    ConfigLine(config_line="vlan 16", parents=("vlan 10",)),
    ConfigLine(config_line="    name phones", parents=("vlan 10", "vlan 16")),
    ConfigLine(config_line="    description phones vlan", parents=("vlan 10", "vlan 16")),
    ConfigLine(config_line="vlan 20", parents=("vlan 10",)),
    ConfigLine(config_line="    name servers vlan", parents=("vlan 10", "vlan 20")),
    ConfigLine(config_line="    description servers vlan", parents=("vlan 10", "vlan 20")),
