...
data = [
    ...
    ConfigLine(config_line=" ************************************************************************", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *                               WARNING                                *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *   Unauthorized access to this device or devices attached to          *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *   or accessible from this network is strictly prohibited.            *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *   Possession of passwords or devices enabling access to this         *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *   device or devices does not constitute authorization. Unauthorized  *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *   access will be prosecuted to the fullest extent of the law.        *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" *                                                                      *", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=" ************************************************************************", parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(config_line=' "', parents=("set devices localhost.localdomain deviceconfig system login-banner \"",)),
    ConfigLine(
